...
function InitializePTZControlBtns(pageName, pageIcon)
{
    ...
    presetBtns.forEach(btn => {
        ...
        btn.addEventListener('touchend', function(){
            ...
            PlayBtnClickSound()
            ProcessCameraCommand("preset_call", btn.id.replace("preset", ""))
        })
    });
}
