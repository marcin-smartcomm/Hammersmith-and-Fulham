...
function FillOutPanelSettings(setupInfo)
{
    ...
    lightingServerIP = setupInfo.lightingServerIP;
...
let originalThemeColors = ["black", "rgb(152, 252, 85)", "white", "rgb(152, 252, 85)", "white", "black"]
let lightModeColors = ["white", "black", "black", "black", "black", "white"]
